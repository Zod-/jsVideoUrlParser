...
URLParser.prototype.create=function(a){var b=a.videoInfo;a.format=a.format||"short";if(this.plugins[b.provider].create)return this.plugins[b.provider].create.call(this,a)};var urlParser=new URLParser;function getTime(a){var b=0,c=0,d,f={s:1,m:60,h:3600,d:86400,w:604800};if(!a.match(/^(\d+[smhdw]?)+$/))return 0;for(d=0;d<a.length;d+=1)"0"<=a[d]&&"9">=a[d]?c=10*c+parseInt(a[d],10):(a[d]in f&&(b+=f[a[d]]*c,delete f[a[d]]),c=0);0!==c&&"s"in f&&(b+=c,delete f.s);return b}
