...
URLParser.prototype.create=function(a){var b=a.videoInfo;a.format=a.format||"short";if(this.plugins[b.provider].create)return this.plugins[b.provider].create.call(this,a)};var urlParser=new URLParser;function getTime(a){var b=0,c=0,d,e={s:1,m:60,h:3600,d:86400,w:604800};if(!a.match(/^(\d+[smhdw]?)+$/))return 0;for(d=0;d<a.length;d+=1)"0"<=a[d]&&"9">=a[d]?c=10*c+parseInt(a[d],10):(a[d]in e&&(b+=e[a[d]]*c,delete e[a[d]]),c=0);0!==c&&"s"in e&&(b+=c,delete e.s);return b}
...
urlParser.bind({provider:"twitch",parse:function(a){var b,c,d,e,f={};d=(b=a.match(/twitch\.tv\/(\w+)(?:\/(.)\/(\d+))?/i))?b[1]:void 0;e=b?b[2]:void 0;c=b?b[3]:void 0;if(d=(b=a.match(/(?:\?channel|\&utm_content)=(\w+)/i))?b[1]:d)return c?(f.mediaType="video",f.videoId=c,f.videoIdPrefix=e):f.mediaType="stream",f.channel=d,f},create:function(a){a=op.videoInfo;return"stream"===a.mediaType?"https://twitch.tv/{0}".format(a.channel):"https://twitch.tv/{0}/{1}/{2}".format(a.channel,a.videoIdPrefix,a.videoId)}});
...
urlParser.bind({provider:"youtube",alternatives:["youtu"],parse:function(a){var b,c,d,e={};c=(b=a.match(/(?:(?:v|be|videos)\/|v=)([\w\-]{11})/i))?b[1]:void 0;d=(b=a.match(/list=([\w\-]+)/i))?b[1]:void 0;a=(b=a.match(/[#\?&](?:star)?t=([A-Za-z0-9]+)/i))?getTime(b[1]):void 0;if(c)e.mediaType="video",e.videoId=c,d&&(e.playlistId=d),a&&(e.startTime=a);else if(d)e.mediaType="playlist",e.playlistId=d;else return;return e},create:function(a){var b=a.videoInfo;if("playlist"===b.mediaType)return"https://www.youtube.com/playlist?feature=share&list={0}".format(b.playlistId);
a=b.playlistId?"https://www.youtube.com/watch?v={0}&list={1}".format(b.videoId,b.playlistId):"short"===a.format?"https://youtu.be/{0}".format(b.videoId):"https://www.youtube.com/watch?v={0}".format(b.videoId);b.startTime&&(a+="#t={0}".format(b.startTime));return a}});
